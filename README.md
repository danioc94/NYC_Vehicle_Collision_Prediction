...
For our machine learning model, we will be using a linear regression model. We chose this model because we want to predict how often car crashes happen and the location of these accidents in NYC.  Our y- variable will be the number of accidents with injuries and fatalities, the input will be time and borough.
