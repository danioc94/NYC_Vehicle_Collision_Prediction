...
For our machine learning model, we will be using a linear regression model. We chose this model because we want to predict how often crash happen and location.  Our y- variable will be the number of accidents with injuries and fatalities, the input will be time and borough.
